    ...
    <div class="container">
        ...
        <form enctype="multipart/form-data" action="ValidaCSV.php" method="POST">
            ...
            <div class="form-group">
                <label for="exampleFormControlFile1">Selecione a tabela <strong>CSV</strong> da transportadora</label>
                <input type="file" class="form-control-file" name="arquivo" id="exampleFormControlFile1">
            </div>
            <button type="submit" class="btn btn-secondary">Enviar e Validar</button>
        </form>
